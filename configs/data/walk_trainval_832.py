...
_CN.DATASET.TRAIN_DATA_SOURCE = "Walk"
_CN.DATASET.TRAIN_WALKDEPTH = False
...
VAL_BASE_PATH = "data/WalkDepth"
_CN.DATASET.VAL_DATA_SOURCE = "MegaDepth" 
_CN.DATASET.VAL_WALKDEPTH = True
_CN.DATASET.VAL_DATA_ROOT = VAL_BASE_PATH
_CN.DATASET.VAL_NPZ_ROOT = f"{VAL_BASE_PATH}"
_CN.DATASET.VAL_LIST_PATH = f"{VAL_BASE_PATH}/valid.txt"
