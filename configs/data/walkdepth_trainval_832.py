...
_CN.DATASET.TRAIN_LIST_PATH = f"{TRAINVAL_BASE_PATH}/train_latest.txt"
...
_CN.DATASET.VAL_LIST_PATH = f"{TRAINVAL_BASE_PATH}/valid_latest.txt"
...
_CN.DATASET.GEOMETRIC_AUGMENTATION = False
