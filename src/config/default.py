...
_CN.DATASET.TEST_WALKDEPTH = None
...
_CN.DATASET.TRAIN.MAX_RESIZE = None
...
_CN.DATASET.TRAIN.SOURCE_ROOT = None
_CN.DATASET.TRAIN.PROPAGATE_ROOT = None
_CN.DATASET.TRAIN.VIDEO_IMAGE_ROOT = None
_CN.DATASET.TRAIN.PSEUDO_LABELS = None
...
_CN.DATASET.VALID.SOURCE_ROOT = None
_CN.DATASET.VALID.PROPAGATE_ROOT = None
_CN.DATASET.VALID.VIDEO_IMAGE_ROOT = None
_CN.DATASET.VALID.PSEUDO_LABELS = None
...
_CN.DATASET.TESTS.SOURCE_ROOT = None
_CN.DATASET.TESTS.PROPAGATE_ROOT = None
_CN.DATASET.TESTS.VIDEO_IMAGE_ROOT = None
_CN.DATASET.TESTS.PSEUDO_LABELS = None
